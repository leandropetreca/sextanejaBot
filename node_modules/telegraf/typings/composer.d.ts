...
declare type UpdateTypes<U extends tt.Update> = Exclude<UnionKeys<U>, keyof tt.Update>;
declare type Getter<U extends tt.Update, P extends string> = PropOr<GetMessageFromAnySource<U>, P, undefined>;
/**
